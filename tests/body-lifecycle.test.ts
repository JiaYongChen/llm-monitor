/** body 生命周期与读写测试 — 落库后外置写文件可读回（读写）+ 删除/合并/清理操作同步维护 body 文件（联动） */
import { describe, it, expect, beforeAll, afterAll } from 'vitest';
import { initDb, closeDb, getDb, insertCall, upsertSession, deleteSession, mergeSessions, cleanupOldCalls, deleteAllSessions, clearAllData } from '../proxy/db.js';
